"""OCT-H (our reimplementation) comprehensive experiments."""
...
for dataset in datasets:
    ...
    for max_depth in [2, 3, 4]:
        ...
        if dataset in sklearn_datasets:
            ...
            X, y = dataset()
        tree = OCT(max_depth=max_depth, hyperplanes=True, time_limit=time_limit)
        ...
        line = ["OCT-H-reimplementation", dataset_name, max_depth,
